...
!!! note "Note"
    **CORS** and **Sessions** are now native core features!
    Check out [The Router](router.md#cors) documentation for details.

### Heaven Plugins
| Plugin | Pypi | Description | Source Code |
| --- | --- | --- | --- |
| SecurityPlugin | heaven_security | Add authentication and authorization to your API. | [Source Code](https://github.com/rayattack/heaven/blob/main/plugins/heaven_pg.py) |
